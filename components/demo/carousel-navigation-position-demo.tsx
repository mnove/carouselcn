...
export default function CarouselNavigationPositionDemo() {
  return (
    <div className="relative w-full max-w-xs pb-12">
      <Carousel>
        <CarouselContent>
        ...
        <CarouselNavigation
          className="absolute -bottom-8 left-auto top-auto w-full justify-center gap-4"
          alwaysShow
        />
