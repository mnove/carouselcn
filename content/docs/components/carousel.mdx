...
Enable seamless infinite scrolling with the `infiniteLoop` prop. Slides transition smoothly in one direction without jumping back.

<ComponentPreview name="carousel-infinite-loop-demo" />
...
<TypeTable
  type={{
    ...
    infiniteLoop: {
      description: 'Enable seamless infinite scrolling',
      type: 'boolean',
      default: 'false',
    },
    className: {
